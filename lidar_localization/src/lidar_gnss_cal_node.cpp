...
{
    std::string lidar_pose_path = WORK_SPACE_PATH + "/slam_data/trajectory/laser_odom_tum.txt";
    std::string gnss_pose_path = WORK_SPACE_PATH + "/slam_data/trajectory/ground_truth_tum.txt";
